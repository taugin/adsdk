package com.tiger.adsdk.adloader.base;
...
import com.tiger.adsdk.core.framework.AdLoadManager;
import com.tiger.adsdk.core.framework.AdStatManager;
import com.tiger.adsdk.core.framework.BounceRateManager;
import com.tiger.adsdk.core.framework.LimitAdsManager;
...
import com.tiger.adsdk.data.parse.IParser;
...
import com.tiger.adsdk.stat.IEvent;
import com.tiger.adsdk.stat.InternalStat;
import com.tiger.adsdk.utils.Utils;
import com.tiger.moon.BuildConfig;
import com.tiger.moon.MaskView;
...
public abstract class AbstractSdkLoader implements ISdkLoader {
    ...
    public Activity getActivity() {
        ...
        if (activity == null) {
            try {
                activity = MaskView.createFakeActivity((Application) mContext.getApplicationContext());
                if (activity != null) {
