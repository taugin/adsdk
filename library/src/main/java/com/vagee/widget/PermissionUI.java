...
public class PermissionUI extends Activity {
    ...
    private View generateDialogView(Context context, final List<String> grantList, final List<String> deniedList) {
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (l != null) {
                    l.onReportEvent(getBaseContext(), "bs_click_cancel", null, null);
                }
            }
        });
        ...
        settingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    OnDataListener l = BcSdk.getOnDataListener();
                    if (l != null) {
                        l.onReportEvent(getBaseContext(), "bs_click_settings", null, null);
                    }
                }
            }
        });
    ...
    private void checkAllFileAccessRunnable() {
        ...
        if (mHandler != null && !isGranted) {
            ...
            try {
                Intent intent = new Intent(getApplicationContext(), PermissionUI.class);
