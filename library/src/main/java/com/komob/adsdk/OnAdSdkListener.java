...
public interface OnAdSdkListener {
    ...
    default void onLoadFailed(String placeName, String source, String adType, String pid, AdError error) {
    }

    default void onShowFailed(String placeName, String source, String adType, String pid, AdError error) {
    }
