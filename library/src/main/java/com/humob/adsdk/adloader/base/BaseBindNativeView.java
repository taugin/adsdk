...
public class BaseBindNativeView {
    ...
    static {
        ...
        AdActivity.bindLayoutMap(LAYOUT_MAPS);
    }
    ...
    private int getAdViewLayout(Context context, String template, PidConfig pidConfig) {
        ...
        if (layoutId == 0) {
            try {
                ...
                layoutId = AdActivity.getLayoutLittle();
            }
        }
        return layoutId;
    }
    ...
    protected void bindParamsViewId(Params params) {
        AdActivity.bindLayoutId(params);
    }
    ...
    protected void setDefaultAdIcon(String platform, ImageView imageView) {
        try {
            ...
            shapeNormal.getPaint().setColor(imageView.getContext().getResources().getColor(AdActivity.getDefaultIconColor()));
            ...
            if (view != null && params != null) {
                if (admob) {
                    if (view instanceof ViewGroup) {
                        setAdChoiceBgColor((ViewGroup) view, "com.facebook.ads.AdOptionsView", Color.parseColor("#CCDDDDDD"));
                    }
                } else {
                    ...
                    if (adChoiceId > 0) {
                        ...
                        if (adChoiceView instanceof ViewGroup) {
                            setAdChoiceBgColor((ViewGroup) adChoiceView, "com.facebook.ads.AdOptionsView", Color.parseColor("#CCDDDDDD"));
                        }
                    }
                }
            }
