...
import com.humob.adsdk.adloader.admob.AdmobLoader;
import com.humob.adsdk.adloader.applovin.AppLovinLoader;
import com.humob.adsdk.adloader.base.SimpleAdBaseBaseListener;
import com.humob.adsdk.adloader.listener.IManagerListener;
import com.humob.adsdk.adloader.listener.ISdkLoader;
import com.humob.adsdk.adloader.listener.OnAdBaseListener;
import com.humob.adsdk.adloader.listener.OnAdSdkInternalListener;
import com.humob.adsdk.adloader.spread.SpLoader;
import com.humob.adsdk.adloader.tradplus.TradPlusLoader;
import com.humob.adsdk.constant.Constant;
import com.humob.adsdk.core.AdPolicy;
import com.humob.adsdk.core.ModuleLoaderHelper;
...
public class AdPlaceLoader extends AdBaseLoader implements IManagerListener, Runnable, Handler.Callback {
    ...
    public class AdPlaceLoaderListener implements OnAdSdkInternalListener {
        ...
        @Override
        public void onLoaded(String placeName, String source, String adType, String pid, long costTime) {
            resetRetryTimes(placeName, source, adType);
            if (hasNotifyLoaded()) {
            ...
            notifyAdLoaded();
            Log.iv(Log.TAG, "notify callback onLoaded place name : " + placeName + " , sdk : " + source + " , type : " + adType + " , pid : " + pid + " , cost time : " + costTime);
            if (mOnAdSdkLoadedListener != null) {
