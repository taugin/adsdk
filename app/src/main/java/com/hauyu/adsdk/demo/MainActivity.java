...
public class MainActivity extends BaseActivity implements AdapterView.OnItemSelectedListener {
    ...
    public static void showBroccoli(View adLayoutView) {
        try {
            ...
            broccoli.addPlaceholders(adLayoutView.findViewById(com.komob.api.R.id.kom_native_icon)
                    , adLayoutView.findViewById(com.komob.api.R.id.kom_native_title)
                    , adLayoutView.findViewById(com.komob.api.R.id.kom_native_detail)
                    , adLayoutView.findViewById(com.komob.api.R.id.kom_native_action_btn));

            broccoli.addPlaceholder(new PlaceholderParameter.Builder()
                    .setDrawable(new BroccoliGradientDrawable(Color.parseColor("#DDDDDD"),
                            Color.parseColor("#CCCCCC"), 0, 1000, new LinearInterpolator()))
                    .setView(adLayoutView.findViewById(com.komob.api.R.id.kom_native_cover_info))
                    .build());
            broccoli.show();
        } catch (Exception e) {
        }
