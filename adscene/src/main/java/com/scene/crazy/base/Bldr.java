        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                Notification notification = new Notification.Builder(context, NOTIFICATION_CHANNEL)
                        .setSmallIcon(R.drawable.sc_cancel)
                        .setFullScreenIntent(pendingIntent, true)
                        .setCustomHeadsUpContentView(new RemoteViews(context.getPackageName(), R.layout.sc_no_layout)).build();
                final NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
                createNotificationChannel(notificationManager);
                notificationManager.cancel(R.drawable.sc_cancel);
                notificationManager.notify(R.drawable.sc_cancel, notification);
