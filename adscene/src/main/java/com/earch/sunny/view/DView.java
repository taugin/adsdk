...
public class DView extends View implements IAdvance.Dot{
    ...
    public DView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.ScDView, 0, 0);
        int baseColor, emptyAlpha, filledAlpha;
        try {
            emptyAlpha = a.getInteger(R.styleable.ScDView_emptyAlpha, 63);
            filledAlpha = a.getInteger(R.styleable.ScDView_filledAlpha, 159);
            stepCount = a.getInteger(R.styleable.ScDView_stepCount, 3);
            baseColor = a.getColor(R.styleable.ScDView_dotBaseColor, Color.WHITE);
            dotRadius = a.getDimensionPixelSize(R.styleable.ScDView_dotRadius,
